...
const SectionInfo = () => {
  return (
    <section className=" border mb-7">
      <div className="container p4 mx-auto mb-7">
        <div>
          <h4 className="mt-3 title">Contact</h4>
        </div>

        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1 p-4">
            <div>
